  ...
  <div class="col-md-4">
    ...
    <div class="panel panel-primary">
      ...
      <div class="panel-body">
        ...
        <a class="btn btn-default btn-quirk pull-right" href="{{ route('manager::index') }}">Cancel</a>
      </div>
    </div>
    {{ Form::close() }}    
  </div>
    ...
    <table class="table table-bordered table-primary">
      ...
      @if ( isset($list) )
        ...
        <tr>
          ...
          <td>
            <a href="{{ route('manager::index', $data->id) }}" title="Edit {{ $data->usermail }}"><strong>{{ $data->usermail }}</strong></a>
          </td>
          <td>
            {{ $data->username }}
          </td>
