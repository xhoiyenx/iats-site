      ...
      <div class="post-profile row">
        <div class="col-xs-12">
          <div class="featured-image">
            @if (!empty($data->image))
            <p style="text-align: center;"><a href="{{ route('www.news.details', $data->blog_id) }}"><img class="img-responsive" src="{{ url('uploads/blog') . '/' . $data->image }}"></a></p>
            @endif
          </div>
          <div class="profile">
            <span class="location">
          ...
          <div class="entry-social" style="margin-bottom: 15px">
            <div class="fb-share-button" data-href="{{ route('www.news.details', $data->blog_id) }}" data-layout="button_count" data-size="large" data-mobile-iframe="true">
